...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1e] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-purple-900 via-indigo-900 to-indigo-800 flex-col items-center justify-center p-12">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-80 h-80 bg-purple-500/30 rounded-full blur-[100px]" />
        <div className="relative text-center">
          ...
          <h2 className="text-3xl font-black text-white mb-3">Join ClassTask</h2>
          <p className="text-indigo-200 text-sm leading-relaxed max-w-xs">
            Create your account and start managing tasks smarter. Choose your role and get instant access.
          </p>
          {/* Role info cards */}
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400 text-sm">Join thousands of peoples already using Daily Task</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Role Dropdown */}
            <div>
              <label className="block text-sm font-semibold text-slate-300 mb-2">Register as</label>
              <div className="relative">
                ...
                {/* Arrow only — no overlapping icon */}
              ...
              <p className="text-xs text-slate-500 mt-1.5 pl-1">
                {formData.role === 'admin'
                  ? '🛡️ Admin can manage all users, blogs, and system settings.'
                  : '👤 User can view tasks, track progress, and manage their profile.'}
              </p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-white/5 border text-white placeholder-slate-600 rounded-xl pl-11 pr-12 py-3 text-sm focus:outline-none focus:ring-2 focus:border-transparent transition ${
              ...
              {confirmPassword && formData.password === confirmPassword && (
                <p className="text-xs text-emerald-400 mt-1.5 pl-1">Passwords match ✓</p>
              )}
            </div>
